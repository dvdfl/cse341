...
exports.recipeValidation = [
    ...
    check('meal_type', 'Servings information is required, must be numeric').not().isEmpty().bail().isLength(3),
    ...
    check('ingredients.*.name', 'Ingredient namey is required').not().isEmpty().bail().isLength(3),
